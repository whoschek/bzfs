...
python3 -m bzfs_docs.update_readme --module=bzfs_main.bzfs --readme=README.md
python3 -m bzfs_docs.update_readme --module=bzfs_main.bzfs_jobrunner --readme=README_bzfs_jobrunner.md
