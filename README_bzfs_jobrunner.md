...
*  Alert the user if the ZFS 'creation' time property of the latest or oldest snapshot for any
    ...
    `prod_onsite_<timestamp>_hourly` is more than 30 + 60*36 minutes old [warning] or
    more than 300 + 60*36 minutes old [critical], where 36 is the number of period cycles
