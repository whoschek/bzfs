...
Run the example replication job after all peer containers are up:
...
zfs list
zfs list -t snapshot
ssh -p 2222 127.0.0.1 echo hello
ssh -p 2222 testsrc01 echo hello
ssh -p 2222 testdst01 echo hello
```
