...
# constants:
__version__: Final[str] = "1.20.0.dev0"
...
""")
    ...
    parser.add_argument(
        ...
        help="For remote-to-remote replication, controls whether the `zfs send` stream is relayed by the initiator "
             ...
             "other than `none`.\n\n"
             "*Note:* `--pv*` progress reporting and `--bwlimit` have no effect in r2r modes. Use `--mbuffer-program-opts` "
             "for bandwidth rate limiting instead. Example to cap throughput at 100 MB/sec: "
             "`--mbuffer-program-opts='-q -m 128M -r 100M -R 100M'`.\n\n")
    parser.add_argument(
