...
def main() -> None:
    ...
    package_json = target_dir / "package" / "package.json"

    if package_json.is_file() and f'"version": "{package_version}"' in package_json.read_text():
        print(f"Nothing to do as {package_name}-{package_version} is already installed at {target_dir}")
        return
