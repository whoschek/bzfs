...
- [bzfs] Add [`lima_ubuntu.sh`](bzfs_testbed/lima_ubuntu.sh) script that uses Lima to locally create a guest Ubuntu VM,
  then runs the bzfs test suite inside of that VM.
