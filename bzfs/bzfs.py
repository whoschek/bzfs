...
--include-snapshot-regex '.*_secondly' --include-snapshot-times-and-ranks '150 seconds ago..anytime' 'latest 150'
--new-snapshot-filter-group 
--include-snapshot-regex '.*_minutely' --include-snapshot-times-and-ranks '90 minutes ago..anytime' 'latest 90'
--new-snapshot-filter-group 
...
""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument(
        ...
        help="Do nothing if the --create-src-snapshots flag is missing. Otherwise, before the replication step (see below), "
             ...
             "with the schedule and --{include|exclude}-dataset* pruning policy. The snapshots of all datasets that fit "
