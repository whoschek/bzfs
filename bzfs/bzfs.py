...
class Job:
    ...
    def clear_resumable_recv_state_if_necessary(self, dst_dataset: str, stderr: str) -> bool:
        ...
        # cannot destroy 'wb_dest/tmp/dst@s1': snapshot has dependent clones ... wb_dest/tmp/dst/%recv
        elif "cannot destroy" in stderr and "snapshot has dependent clones" in stderr and "/%recv" in stderr:
            return clear_resumable_recv_state()
